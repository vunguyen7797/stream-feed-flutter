...
NextParams parseNext(String next) {
  ...
  final nextParams = NextParams(
      idLT: queryParameters['id_lt'] != null ? Filter().idLessThan(queryParameters['id_lt']!) : null,
      ...
      recentReactionsLimit:
          queryParameters['recentReactionsLimit'] != null ? int.tryParse(queryParameters['recentReactionsLimit']!) : null,
